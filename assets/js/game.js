...
var fightOrSkip = function () {
    ...
    // convert promptFlight to all lowercase so we can check with less options
...
var fight = function (enemy) {
    ...
    while( playerInfo.health > 0 && enemy.health > 0) {
        if (isPlayerTurn) {
            ...
            // generate random damage values based on player's attack power
...
var startGame = function () {
    ...
    for(var i = 0; i < enemyInfo.length; i++) {
        ...
        if (playerInfo.health > 0) {
            ...
            //if player i still alive andwe're not the last enemy in the array
            if (playerInfo.health > 0 && i < enemyInfo.length - 1) {
                //ask if player wants to user the store before next round
...
var shop = function() {
    ...
    // convert answerfrom prompt to an actual number
